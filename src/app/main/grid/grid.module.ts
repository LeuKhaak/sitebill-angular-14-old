...
import { NgxUploaderModule } from 'ngx-uploader'; // old ???
import { UploadxModule} from 'ngx-uploadx'; // new ???
// import { NgxGalleryModule } from 'ngx-gallery-9'; // old ??? НЕ УСТАНАВЛИВАЕТСЯ
...
// import { NgxDaterangepickerMd } from 'ngx-daterangepicker-material'; // old ??? ОШИБКА
...
const routes = [
  ...
  // {
  //   path        : 'favorites',
  //   loadChildren: () => import('src/app/main/grid/memorylist-client/memorylist-client.module').then(m => m.MemorylistClientModule),
  // },
  // { // src/app/main/grid/memorylist-client/memorylist-client.module
