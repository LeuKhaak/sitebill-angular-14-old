...
export class FilterIterator {
  ...
  iterate (share_array: any[], operation: string) {
    let counter = 0;
...
export class FilterService {
  private share_array: ArrayTypes = [];
  private params_count: ArrayTypes = [];
  private share_counter_array: ArrayTypes = [];
