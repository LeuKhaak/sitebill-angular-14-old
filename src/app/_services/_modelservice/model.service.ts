...
import { GetSessionKeyService } from '../get-session-key.service'; // Circular dependency !!!
...
export class ModelService {
  ...
  get sitebill_session(): SitebillSession {
    return {
      sessionId:  'edc28d4aabbff8d7506b8bcf3d978c7f',// this.getSessionKeyService.get_session_key(),
      clientUrl:
  ...
  load(
    ...
    const body = {
      ...
      session_key:  'edc28d4aabbff8d7506b8bcf3d978c7f',//this.getSessionKeyService.get_session_key_safe(),
      grid_item: grid_item,
    };
    // console.log(body);
